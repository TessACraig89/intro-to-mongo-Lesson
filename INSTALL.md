...
```
alexwhite:wdi_8_mongo_intro cwilbur$ brew install mongo
...
```
alexwhite:wdi_8_mongo_intro cwilbur$ ln -sfv /usr/local/opt/mongodb/*.plist ~/Library/LaunchAgents
...
OR type `brew services start mongodb`
...
```
Alex's Macbook Pro:mongodb-crud alexwhite$ mongo
